...
public class EvictionDUnitTest {
  ...
  public static void classSetup() {
    ...
    serverProperties.setProperty(REDIS_CRITICAL_HEAP_PCT, "5");
  ...
  @Test
  public void shouldAllowWriteOperations_afterUsedMemoryDropsBelowThreshold() {
    IgnoredException.addIgnoredException(expectedEx);
    IgnoredException.addIgnoredException("LowMemoryException");
    ...
    assertThatNoException().isThrownBy(() -> jedis2.set("oneMoreKey", "value"));
  }
